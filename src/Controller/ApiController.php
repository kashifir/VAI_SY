...
class ApiController extends AbstractController
{
    ...
    final public function getTest(ManagerRegistry $doctrine, Request $request): JsonResponse
    {
        ...
        foreach ($objdata as $x => $val) {
            if ($val['Noms'] === "man or woman" || $val['Noms'] === "Age") {
                ...
                $reponse[] = $this->getOneTest($testdev, $data);
            }
     ...
     * @return array
     */
    final public function getOneTest($test, string $data): array
    {
        $repose = [];
...
// end
     ...
     */
    public
    function getArr(mixed $test, float|bool|int|string|null $data): array
    {
        $repose[] = [
            'Noms' => $test->getNoms(),
